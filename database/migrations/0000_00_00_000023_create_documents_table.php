...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('documents', function (Blueprint $table) {
            ...
            $table->uuid('document_category_id')->nullable()->references('id')->on('categories')->nullOnDelete()->cascadeOnUpdate(); // document_category_id is the folder that the document is in
