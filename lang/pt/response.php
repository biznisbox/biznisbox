...
return [
    ...
    'vendor' => [
        ...
        'get_success' => 'Fornecedores recuperados com sucesso',
        'get_failed' => 'Fornecedores não puderam ser recuperados',
        'create_success' => 'Fornecedor criado com sucesso',
        'create_failed' => 'Um fornecedor não pôde ser criado',
        'update_success' => 'Fornecedor atualizado com sucesso',
        'update_failed' => 'Um fornecedor não pôde ser atualizado',
        'delete_success' => 'Fornecedor excluído com sucesso',
        'delete_failed' => 'Um fornecedor não pôde ser excluído',
    ],
    ...
    //Customer responses
    'customer' => [
        'get_success' => 'Clientes recuperados com sucesso',
        'get_failed' => 'Não foi possível recuperar os clientes',
        'not_found' => 'Cliente não pôde ser encontrado',
        'create_failed' => 'Cliente não pôde ser criado',
    ...
    //Estimate responses
    'estimate' => [
        'get_success' => 'Estimativas recuperadas com sucesso',
        'get_failed' => 'Estimativas não puderam ser recuperadas',
        'not_found' => 'Não foi possível encontrar a estimativa',
        'create_failed' => 'A estimativa não pôde ser criada',
        'create_success' => 'Estimativa criada com sucesso',
        'convert_success' => 'Estimativa foi convertida em fatura com sucesso',
        'update_success' => 'Estimativa atualizada com sucesso',
        'delete_success' => 'Estimativa foi excluída com sucesso',
        'delete_failed' => 'A estimativa não pôde ser apagada',
        'update_failed' => 'Estimativa não pode ser atualizada',
        'share_success' => 'Estimativa foi compartilhada com sucesso',
        'share_failed' => 'A estimativa não pôde ser compartilhada',
        'accept_reject_success' => 'Estimativa rejeitada com sucesso',
        'send_success' => 'Estimativa enviada com sucesso',
        'send_failed' => 'Não foi possível enviar a estimativa',
