...
return [
    ...
    // Vendor responses
    'vendor' => [
        'not_found' => 'Leverantören hittades inte',
        'get_success' => 'Leverantörer hämtade framgångsrikt',
        'get_failed' => 'Leverantörer kunde inte hämtas',
        'create_success' => 'Leverantören har skapats',
        'create_failed' => 'En leverantör kunde inte skapas',
        'update_success' => 'Leverantören har uppdaterats',
        'update_failed' => 'En leverantör kunde inte uppdateras',
        'delete_success' => 'Leverantören har tagits bort',
        'delete_failed' => 'En leverantör kunde inte tas bort',
    ],
    ...
    //Customer responses
    'customer' => [
        'get_success' => 'Kunder har hämtats',
        'get_failed' => 'Kunder kunde inte hämtas',
        'not_found' => 'Kunden kunde inte hittas',
        'create_failed' => 'Kunden kunde inte skapas',
        'create_success' => 'Kunden har skapats',
        'update_success' => 'Kunden har uppdaterats',
        'delete_success' => 'Kunden har tagits bort',
    ],
    ...
    //Estimate responses
    'estimate' => [
        'get_success' => 'Uppskattningar har hämtats',
        'get_failed' => 'Uppskattningar kunde inte hämtas',
        'not_found' => 'Uppskattningen kunde inte hittas',
        'create_failed' => 'Uppskattningen kunde inte skapas',
        'create_success' => 'Uppskattningen har skapats',
        'convert_success' => 'Uppskattningen har konverterats till faktura',
        'update_success' => 'Uppskattningen har uppdaterats',
        'delete_success' => 'Uppskattningen har tagits bort',
        'delete_failed' => 'Uppskattningen kunde inte tas bort',
        'update_failed' => 'Uppskattningen kunde inte uppdateras',
        'share_success' => 'Uppskattningen delades framgångsrikt',
        'share_failed' => 'Uppskattningen kunde inte delas',
        'accept_reject_success' => 'Uppskattningen har avvisats',
        'send_success' => 'Uppskattningen har skickats',
        'send_failed' => 'Uppskattningen kunde inte skickas',
