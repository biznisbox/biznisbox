...
return [
    ...
    // Vendor responses
    'vendor' => [
        'not_found' => 'Ο προμηθευτής δεν βρέθηκε',
        'get_success' => 'Οι προμηθευτές ανακτήθηκαν με επιτυχία',
        'get_failed' => 'Οι προμηθευτές δεν μπόρεσαν να ανακτηθούν',
        'create_success' => 'Ο προμηθευτής δημιουργήθηκε με επιτυχία',
        'create_failed' => 'Αδυναμία δημιουργίας ενός προμηθευτή',
        'update_success' => 'Ο προμηθευτής ενημερώθηκε επιτυχώς',
        'update_failed' => 'Δεν ήταν δυνατή η ενημέρωση ενός προμηθευτή',
        'delete_success' => 'Ο προμηθευτής διαγράφηκε επιτυχώς',
        'delete_failed' => 'Δεν ήταν δυνατή η διαγραφή ενός προμηθευτή',
    ],
    ...
    //Customer responses
    'customer' => [
        'get_success' => 'Οι πελάτες ανακτήθηκαν με επιτυχία',
        'get_failed' => 'Οι πελάτες δεν μπόρεσαν να ανακτηθούν',
        'not_found' => 'Ο πελάτης δεν βρέθηκε',
        'create_failed' => 'Δεν ήταν δυνατή η δημιουργία πελάτη',
        'create_success' => 'Πελάτης δημιουργήθηκε με επιτυχία',
        'update_success' => 'Ο πελάτης ενημερώθηκε με επιτυχία',
        'delete_success' => 'Πελάτης διαγράφηκε επιτυχώς',
    ],
    ...
    //Estimate responses
    'estimate' => [
        'get_success' => 'Επιτυχής ανάκτηση εκτιμήσεων',
        'get_failed' => 'Δεν ήταν δυνατή η ανάκτηση εκτιμήσεων',
        'not_found' => 'Δεν ήταν δυνατή η εύρεση εκτίμησης',
        'create_failed' => 'Δεν ήταν δυνατή η δημιουργία εκτίμησης',
        'create_success' => 'Ο υπολογισμός δημιουργήθηκε με επιτυχία',
        'convert_success' => 'Η εκτίμηση μετατράπηκε επιτυχώς σε τιμολόγιο',
        'update_success' => 'Η εκτίμηση ενημερώθηκε με επιτυχία',
        'delete_success' => 'Η εκτίμηση διαγράφηκε με επιτυχία',
        'delete_failed' => 'Δεν ήταν δυνατή η διαγραφή της εκτίμησης',
        'update_failed' => 'Δεν ήταν δυνατή η ενημέρωση των εκτιμήσεων',
        'share_success' => 'Η εκτίμηση κοινοποιήθηκε με επιτυχία',
        'share_failed' => 'Δεν ήταν δυνατή η κοινή χρήση της εκτίμησης',
        'accept_reject_success' => 'Η εκτίμηση απορρίφθηκε με επιτυχία',
        'send_success' => 'Η εκτίμηση εστάλη επιτυχώς',
        'send_failed' => 'Δεν ήταν δυνατή η αποστολή της εκτίμησης',
