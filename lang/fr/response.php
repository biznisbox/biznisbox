...
return [
    ...
    'create_failed' => 'Impossible de créer',
    ...
    'get_success' => 'Récupéré avec succès',
    'get_failed' => 'Impossible de récupérer',
    'upload_success' => 'Téléchargé avec succès',
    'upload_failed' => 'Impossible de télécharger',
    'remove_success' => 'Supprimé avec succès',
    'remove_failed' => 'Impossible de supprimer',
    'send_success' => 'Envoyé avec succès',
    'send_failed' => 'Ne peut pas être envoyé',
    'share_success' => 'Partagé avec succès',
    'share_failed' => 'Impossible de partager',
    'accept_reject_success' => 'Accepté/rejeté avec succès',
    ...
    'no_key_provided' => 'Aucune clé fournie',
    'ping' => 'L\'API fonctionne',
    // Auth responses
    'login' => [
    ...
    'support_ticket_message' => [
        ...
        'not_found' => 'Le message de ticket de support est introuvable',
        'create_failed' => 'Le message de ticket de support n\'a pas pu être créé',
        'create_success' => 'Le message de ticket de support a été créé avec succès',
        'update_success' => 'Le message du ticket d\'assistance a été mis à jour avec succès',
        'update_failed' => 'Le message de ticket de support n\'a pas pu être mis à jour',
    ...
    'support_ticket' => [
        ...
        'not_found' => 'Ticket de support introuvable',
        'create_failed' => 'Le ticket de support n\'a pas pu être créé',
        'create_success' => 'Ticket de support a été créé avec succès',
        'update_success' => 'Le ticket d\'assistance a été mis à jour avec succès',
        'update_failed' => 'Le ticket d\'assistance n\'a pas pu être mis à jour',
        'delete_failed' => 'Le ticket de support n\'a pas pu être supprimé avec succès',
        'delete_success' => 'Ticket de support supprimé avec succès',
        'get_number_success' => 'Numéro de ticket de support récupéré avec succès',
        'get_number_failed' => 'Le numéro de ticket de support n\'a pas pu être récupéré',
        'send_success' => 'Le message de ticket d\'assistance a été envoyé avec succès',
        'send_failed' => 'Le message de ticket de support n\'a pas pu être envoyé',
    ...
    'user' => [
        ...
        'avatar_deleted' => 'L\'avatar a été supprimé avec succès',
