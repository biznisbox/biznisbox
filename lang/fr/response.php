...
return [
    ...
    'vendor' => [
        ...
        'get_success' => 'Fournisseurs récupérés avec succès',
        'get_failed' => 'Les fournisseurs n\'ont pas pu être récupérés',
        'create_success' => 'Fournisseur créé avec succès',
        'create_failed' => 'Un vendeur n\'a pas pu être créé',
        'update_success' => 'Fournisseur mis à jour avec succès',
        'update_failed' => 'Un vendeur n\'a pas pu être mis à jour',
        'delete_success' => 'Fournisseur supprimé avec succès',
        'delete_failed' => 'Un vendeur n\'a pas pu être supprimé',
    ],
    ...
    //Customer responses
    'customer' => [
        'get_success' => 'Clients récupérés avec succès',
        'get_failed' => 'Les clients n\'ont pas pu être récupérés',
        'not_found' => 'Le client est introuvable',
        'create_failed' => 'Le client n\'a pas pu être créé',
        'create_success' => 'Le client a été créé avec succès',
        'update_success' => 'Client a été mis à jour avec succès',
    ...
    //Estimate responses
    'estimate' => [
        'get_success' => 'Estimations récupérées avec succès',
        'get_failed' => 'Les devis n\'ont pas pu être récupérés',
        'not_found' => 'L\'estimation n\'a pas pu être trouvée',
        'create_failed' => 'L\'estimation n\'a pas pu être créée',
        'create_success' => 'Le devis a été créé avec succès',
        'convert_success' => 'L\'estimation a été convertie en facture avec succès',
        'update_success' => 'L\'estimation a été mise à jour avec succès',
        'delete_success' => 'L\'estimation a été supprimée avec succès',
        'delete_failed' => 'L\'estimation n\'a pas pu être supprimée',
        'update_failed' => 'L\'estimation n\'a pas pu être mise à jour',
        'share_success' => 'L\'estimation a été partagée avec succès',
        'share_failed' => 'L\'estimation n\'a pas pu être partagée',
        'accept_reject_success' => 'L\'estimation a été rejetée avec succès',
        'send_success' => 'L\'estimation a été envoyée avec succès',
        'send_failed' => 'L\'estimation n\'a pas pu être envoyée',
