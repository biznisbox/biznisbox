...
return [
    ...
    'vendor' => [
        ...
        'get_success' => 'Vendedores recuperados con éxito',
        'get_failed' => 'No se pudieron recuperar los vendedores',
        'create_success' => 'Vendedor creado con éxito',
        'create_failed' => 'No se pudo crear un proveedor',
        'update_success' => 'Vendor actualizado correctamente',
        'update_failed' => 'No se ha podido actualizar un proveedor',
        'delete_success' => 'Vendor eliminado correctamente',
        'delete_failed' => 'No se ha podido eliminar un proveedor',
    ],
    ...
    //Customer responses
    'customer' => [
        'get_success' => 'Clientes recuperados con éxito',
        'get_failed' => 'Los clientes no pudieron ser recuperados',
        'not_found' => 'No se pudo encontrar el cliente',
        'create_failed' => 'El cliente no pudo ser creado',
    ...
    //Estimate responses
    'estimate' => [
        'get_success' => 'Estimaciones obtenidas con éxito',
        'get_failed' => 'No se pudieron recuperar las estimaciones',
        'not_found' => 'No se pudo encontrar la estimación',
        'create_failed' => 'No se pudo crear la estimación',
        'create_success' => 'La estimación se ha creado correctamente',
        'convert_success' => 'La estimación se ha convertido en factura con éxito',
        'update_success' => 'La estimación se ha actualizado correctamente',
        'delete_success' => 'La estimación se ha eliminado correctamente',
        'delete_failed' => 'No se ha podido eliminar la estimación',
        'update_failed' => 'No se pudo actualizar la estimación',
        'share_success' => 'La estimación se ha compartido correctamente',
        'share_failed' => 'No se pudo compartir la estimación',
        'accept_reject_success' => 'La estimación fue rechazada con éxito',
        'send_success' => 'La estimación se ha enviado correctamente',
        'send_failed' => 'No se pudo enviar la estimación',
