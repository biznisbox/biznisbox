...
return [
    ...
    'support_ticket' => [
        ...
        'delete_failed' => 'No se ha podido eliminar correctamente el ticket de soporte',
        'delete_success' => 'Ticket de soporte eliminado correctamente',
        'get_number_success' => 'Número de ticket de soporte obtenido con éxito',
        'get_number_failed' => 'No se ha podido recuperar el número de ticket de soporte',
        'send_success' => 'Mensaje de ticket de soporte enviado correctamente',
        'send_failed' => 'No se pudo enviar el mensaje de ticket de soporte',
        'share_success' => 'Ticket de soporte compartido con éxito',
        'share_failed' => 'No se pudo compartir el ticket de soporte',
    ],
    //Profile responses
    'user' => [
