...
return [
    ...
    'vendor' => [
        ...
        'get_success' => 'تم استرجاع البائعين بنجاح',
        'get_failed' => 'تعذر استرجاع البائعين',
        'create_success' => 'تم إنشاء البائع بنجاح',
        'create_failed' => 'تعذر إنشاء بائع',
        'update_success' => 'تم تحديث البائع بنجاح',
        'update_failed' => 'تعذر تحديث بائع',
        'delete_success' => 'تم حذف البائع بنجاح',
        'delete_failed' => 'لا يمكن حذف بائع',
    ],
    ...
    //Customer responses
    'customer' => [
        'get_success' => 'تم استرجاع العملاء بنجاح',
        'get_failed' => 'لا يمكن استرجاع العملاء',
        'not_found' => 'تعذر العثور على العميل',
        'create_failed' => 'تعذر إنشاء العميل',
    ...
    //Estimate responses
    'estimate' => [
        'get_success' => 'تم استرداد التقديرات بنجاح',
        'get_failed' => 'لا يمكن استرجاع التقديرات',
        'not_found' => 'تعذر العثور على التقدير',
        'create_failed' => 'لا يمكن إنشاء التقدير',
        'create_success' => 'تم إنشاء التقدير بنجاح',
        'convert_success' => 'تم تحويل التقدير إلى الفاتورة بنجاح',
        'update_success' => 'تم تحديث التقدير بنجاح',
        'delete_success' => 'تم حذف التقدير بنجاح',
        'delete_failed' => 'لا يمكن حذف التقدير',
        'update_failed' => 'لا يمكن تحديث التقدير',
        'share_success' => 'تم مشاركة التقدير بنجاح',
        'share_failed' => 'لا يمكن مشاركة التقدير',
        'accept_reject_success' => 'تم رفض التقدير بنجاح',
        'send_success' => 'تم إرسال التقدير بنجاح',
        'send_failed' => 'لا يمكن إرسال التقدير',
