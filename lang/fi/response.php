...
return [
    ...
    // Vendor responses
    'vendor' => [
        'not_found' => 'Valmistajaa ei löytynyt',
        'get_success' => 'Toimittajat noudettu onnistuneesti',
        'get_failed' => 'Toimittajia ei voitu hakea',
        'create_success' => 'Valmistaja luotu onnistuneesti',
        'create_failed' => 'Toimittajaa ei voitu luoda',
        'update_success' => 'Valmistaja päivitetty onnistuneesti',
        'update_failed' => 'Toimittajaa ei voitu päivittää',
        'delete_success' => 'Valmistaja poistettu onnistuneesti',
        'delete_failed' => 'Toimittajaa ei voitu poistaa',
    ],
    ...
    //Customer responses
    'customer' => [
        'get_success' => 'Asiakkaat nousivat onnistuneesti',
        'get_failed' => 'Asiakkaita ei voitu hakea',
        'not_found' => 'Asiakasta ei löytynyt',
        'create_failed' => 'Asiakasta ei voitu luoda',
        'create_success' => 'Asiakas luotiin onnistuneesti',
        'update_success' => 'Asiakas päivitettiin onnistuneesti',
        'delete_success' => 'Asiakas poistettu onnistuneesti',
    ],
    ...
    //Estimate responses
    'estimate' => [
        'get_success' => 'Arviot haettu onnistuneesti',
        'get_failed' => 'Arvioita ei voitu hakea',
        'not_found' => 'Arviota ei löytynyt',
        'create_failed' => 'Arviota ei voitu luoda',
        'create_success' => 'Arvio luotiin onnistuneesti',
        'convert_success' => 'Arvio muunnettiin laskuksi onnistuneesti',
        'update_success' => 'Arvio päivitettiin onnistuneesti',
        'delete_success' => 'Arvio poistettiin onnistuneesti',
        'delete_failed' => 'Arviota ei voitu poistaa',
        'update_failed' => 'Arviota ei voitu päivittää',
        'share_success' => 'Arvio jaettiin onnistuneesti',
        'share_failed' => 'Arviota ei voitu jakaa',
        'accept_reject_success' => 'Arvio hylättiin onnistuneesti',
        'send_success' => 'Arvio lähetettiin onnistuneesti',
        'send_failed' => 'Arviota ei voitu lähettää',
