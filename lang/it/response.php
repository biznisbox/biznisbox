...
return [
    ...
    'vendor' => [
        ...
        'get_success' => 'Fornitori recuperati con successo',
        'get_failed' => 'I fornitori non possono essere recuperati',
        'create_success' => 'Fornitore creato con successo',
        'create_failed' => 'Impossibile creare un venditore',
        'update_success' => 'Fornitore aggiornato con successo',
        'update_failed' => 'Un venditore non può essere aggiornato',
        'delete_success' => 'Fornitore eliminato con successo',
        'delete_failed' => 'Un venditore non può essere eliminato',
    ],
    ...
    //Customer responses
    'customer' => [
        'get_success' => 'Clienti recuperati con successo',
        'get_failed' => 'I clienti non possono essere recuperati',
        'not_found' => 'Impossibile trovare il cliente',
        'create_failed' => 'Il cliente non può essere creato',
        'create_success' => 'Cliente creato con successo',
        'update_success' => 'Cliente aggiornato con successo',
        'delete_success' => 'Cliente eliminato con successo',
    ],
    ...
    //Estimate responses
    'estimate' => [
        'get_success' => 'Stime recuperate con successo',
        'get_failed' => 'Non è stato possibile recuperare le stime',
        'not_found' => 'Non è stato possibile trovare la stima',
        'create_failed' => 'Impossibile creare la stima',
        'create_success' => 'Stima creata con successo',
        'convert_success' => 'Il preventivo è stato convertito in fattura con successo',
        'update_success' => 'Stima aggiornata con successo',
        ...
        'share_success' => 'Stima condivisa con successo',
        'share_failed' => 'Il preventivo non può essere condiviso',
        'accept_reject_success' => 'Il preventivo è stato rifiutato con successo',
        'send_success' => 'Stima inviata con successo',
        'send_failed' => 'Non è stato possibile inviare la stima',
