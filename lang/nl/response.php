...
return [
    ...
    'vendor' => [
        ...
        'get_success' => 'Leveranciers succesvol opgehaald',
        'get_failed' => 'Leveranciers konden niet worden opgehaald',
        'create_success' => 'Leverancier succesvol aangemaakt',
        'create_failed' => 'Een verkoper kon niet worden aangemaakt',
        'update_success' => 'Leverancier succesvol bijgewerkt',
        'update_failed' => 'Een verkoper kon niet worden bijgewerkt',
        'delete_success' => 'Leverancier succesvol verwijderd',
        'delete_failed' => 'Een verkoper kon niet verwijderd worden',
    ],
    ...
    //Customer responses
    'customer' => [
        'get_success' => 'Klanten met succes opgehaald',
        'get_failed' => 'Klanten konden niet worden opgehaald',
        'not_found' => 'Klant kon niet worden gevonden',
        'create_failed' => 'Klant kon niet worden aangemaakt',
        'create_success' => 'Klant is succesvol aangemaakt',
        'update_success' => 'Klant is succesvol bijgewerkt',
        'delete_success' => 'Klant succesvol verwijderd',
    ],
    ...
    //Estimate responses
    'estimate' => [
        'get_success' => 'Schattingen met succes opgehaald',
        'get_failed' => 'Schattingen konden niet worden opgehaald',
        'not_found' => 'Offerte kon niet worden gevonden',
        'create_failed' => 'Offerte kon niet worden aangemaakt',
        'create_success' => 'Offerte is met succes aangemaakt',
        'convert_success' => 'Schatting is succesvol omgezet naar factuur',
        'update_success' => 'Offerte is succesvol bijgewerkt',
        'delete_success' => 'Offerte is succesvol verwijderd',
        'delete_failed' => 'Offerte kon niet worden verwijderd',
        'update_failed' => 'Offerte kon niet worden bijgewerkt',
        'share_success' => 'Offerte werd met succes gedeeld',
        'share_failed' => 'Offerte kon niet worden gedeeld',
        'accept_reject_success' => 'Offerte is succesvol afgewezen',
        'send_success' => 'De raming werd met succes verzonden',
        'send_failed' => 'Offerte kon niet worden verzonden',
