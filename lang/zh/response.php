...
return [
    ...
    'vendor' => [
        ...
        'get_success' => '供应商检索成功',
        'get_failed' => '无法检索供应商',
        'create_success' => '供应商创建成功',
        'create_failed' => '无法创建供应商',
        'update_success' => '供应商更新成功',
        'update_failed' => '一个供应商无法更新',
        'delete_success' => '供应商删除成功',
        'delete_failed' => '一个供应商不能被删除',
    ],
    ...
    'customer' => [
        ...
        'get_failed' => '无法检索客户',
        'not_found' => '找不到客户',
        'create_failed' => '无法创建客户',
        'create_success' => '客户已成功创建',
        'update_success' => '客户已成功更新',
        'delete_success' => '客户删除成功',
    ],
    ...
    'estimate' => [
        ...
        'get_failed' => '无法检索估计数',
        'not_found' => '无法找到估计',
        'create_failed' => '无法创建估计',
        'create_success' => '估计已成功创建',
        'convert_success' => '估计已成功转换为发票',
        'update_success' => '估计已成功更新',
        'delete_success' => '估计已成功删除',
        'delete_failed' => '无法删除估计',
        'update_failed' => '无法更新估计',
        'share_success' => '估计已成功共享',
        'share_failed' => '无法共享估计',
        'accept_reject_success' => '估计成功拒绝',
        'send_success' => '估计已成功发送',
        'send_failed' => '无法发送估计',
