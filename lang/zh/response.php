...
return [
    ...
    'share_success' => '共享成功',
    'share_failed' => '无法共享',
    'accept_reject_success' => '已成功接受/拒绝',
    'convert_success' => '转换成功',
    'pdf_failed' => '生成 PDF 失败',
    'notification_success' => '通知已成功发送',
    'notification_failed' => '无法发送通知',
    'no_key_provided' => '未提供密钥',
    'ping' => 'API 正常工作',
    // Auth responses
    'login' => [
        'success' => '您已成功登录',
    ...
    'support_ticket_message' => [
        'get_success' => '支持服务单消息已成功获取',
        'get_failed' => '无法检索支持服务单消息',
        'not_found' => '无法找到支持服务单消息',
        'create_failed' => '无法创建支持服务单消息',
        'create_success' => '支持服务单消息已成功创建',
        'update_success' => '已成功更新支持工单消息',
        'update_failed' => '无法更新支持服务单消息',
        'delete_failed' => '无法成功删除支持服务单消息',
        'delete_success' => '支持服务单消息已成功删除',
    ],
    //Invoice responses
    'invoice' => [
        'get_success' => '已成功获取发票',
    ...
    'support_ticket' => [
        'get_success' => '支持工单检索成功',
        'get_failed' => '无法检索支持票',
        'not_found' => '找不到支持服务单',
        'create_failed' => '无法创建支持服务单',
        'create_success' => '支持服务单已成功创建',
        'update_success' => '支持服务单已成功更新',
        'update_failed' => '无法更新支持服务单',
        'delete_failed' => '支持服务单无法成功删除',
        'delete_success' => '支持工单删除成功',
        'get_number_success' => '支持工单号码检索成功',
        'get_number_failed' => '无法获取支持票号',
        'send_success' => '支持工单信息已成功发送',
        'send_failed' => '无法发送支持服务单消息',
        'share_success' => '支持服务单已成功共享',
        'share_failed' => '无法共享支持服务单',
    ],
    //Profile responses
    'user' => [
        'not_found' => '找不到用户',
        ...
        'avatar_deleted' => '头像已成功删除',
        'avatar_not_found' => '找不到头像',
    ...
    'admin' => [
        ...
        'email' => [
            'test_email_sent' => '测试邮件已成功发送',
            'test_email_failed' => '无法发送测试电子邮件',
        ],
    ],
    'memory_used' => '内存已使用',
