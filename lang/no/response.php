...
return [
    ...
    // Vendor responses
    'vendor' => [
        'not_found' => 'Leverandør ikke funnet',
        'get_success' => 'Vellykket henting av leverandører',
        'get_failed' => 'Leverandører kunne ikke hentes',
        'create_success' => 'Leverandør opprettet',
        'create_failed' => 'En leverandør kan ikke opprettes',
        'update_success' => 'Vellykket oppdatering av bruker',
        'update_failed' => 'En leverandør kunne ikke oppdateres',
        'delete_success' => 'Sluttbruker ble slettet',
        'delete_failed' => 'En leverandør kan ikke slettes',
    ],
    ...
    //Customer responses
    'customer' => [
        'get_success' => 'Hentet av kunder',
        'get_failed' => 'Kunder kunne ikke hentes',
        'not_found' => 'Kunde ble ikke funnet',
        'create_failed' => 'Kunden kunne ikke opprettes',
        'create_success' => 'Kunden ble opprettet',
        'update_success' => 'Oppdatering av kunden var vellykket',
        'delete_success' => 'Kunden ble slettet',
    ],
    ...
    //Estimate responses
    'estimate' => [
        'get_success' => 'Estimater hentet',
        'get_failed' => 'Estimatene kunne ikke hentes',
        'not_found' => 'Estimat ble ikke funnet',
        'create_failed' => 'Estimat kunne ikke opprettes',
        'create_success' => 'Estimat ble opprettet',
        'convert_success' => 'Estimat ble konvertert til faktura vellykket',
        'update_success' => 'Estimat ble oppdatert',
        'delete_success' => 'Estimat ble slettet',
        'delete_failed' => 'Estimat kan ikke slettes',
        'update_failed' => 'Estimat kunne ikke oppdateres',
        'share_success' => 'Estimat ble vellykket delt',
        'share_failed' => 'Estimat kunne ikke deles',
        'accept_reject_success' => 'Estimat ble avvist',
        'send_success' => 'Estimat ble sendt',
        'send_failed' => 'Estimat kunne ikke sendes',
