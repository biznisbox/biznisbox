...
return [
    ...
    'vendor' => [
        ...
        'get_success' => 'Anbieter erfolgreich abgerufen',
        'get_failed' => 'Anbieter konnten nicht abgerufen werden',
        'create_success' => 'Lieferant erfolgreich erstellt',
        'create_failed' => 'Ein Hersteller konnte nicht erstellt werden',
        'update_success' => 'Lieferant erfolgreich aktualisiert',
        'update_failed' => 'Ein Hersteller konnte nicht aktualisiert werden',
        'delete_success' => 'Lieferant erfolgreich gelöscht',
        'delete_failed' => 'Ein Hersteller konnte nicht gelöscht werden',
    ],
    ...
    //Customer responses
    'customer' => [
        'get_success' => 'Kunden erfolgreich abgerufen',
        'get_failed' => 'Kunden konnten nicht abgerufen werden',
        'not_found' => 'Kunde konnte nicht gefunden werden',
        'create_failed' => 'Kunde konnte nicht erstellt werden',
        'create_success' => 'Kunde wurde erfolgreich erstellt',
        'update_success' => 'Kunde wurde erfolgreich aktualisiert',
        'delete_success' => 'Kunde erfolgreich gelöscht',
    ],
    ...
    //Estimate responses
    'estimate' => [
        'get_success' => 'Schätzungen erfolgreich abgerufen',
        'get_failed' => 'Schätzungen konnten nicht abgerufen werden',
        'not_found' => 'Schätzung wurde nicht gefunden',
        'create_failed' => 'Schätzung konnte nicht erstellt werden',
        'create_success' => 'Schätzung wurde erfolgreich erstellt',
        'convert_success' => 'Schätzung wurde erfolgreich in Rechnung konvertiert',
        'update_success' => 'Schätzung wurde erfolgreich aktualisiert',
        'delete_success' => 'Schätzung wurde erfolgreich gelöscht',
        'delete_failed' => 'Schätzung konnte nicht gelöscht werden',
        'update_failed' => 'Schätzung konnte nicht aktualisiert werden',
        'share_success' => 'Schätzung wurde erfolgreich geteilt',
        'share_failed' => 'Schätzung konnte nicht geteilt werden',
        'accept_reject_success' => 'Schätzung wurde erfolgreich abgelehnt',
        'send_success' => 'Schätzung wurde erfolgreich gesendet',
        'send_failed' => 'Schätzung konnte nicht gesendet werden',
