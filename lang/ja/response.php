...
return [
    ...
    // Vendor responses
    'vendor' => [
        'not_found' => '仕入先が見つかりません',
        'get_success' => 'ベンダが正常に取得されました',
        'get_failed' => '仕入先を取得できませんでした',
        'create_success' => '仕入先を作成しました',
        'create_failed' => 'ベンダを作成できませんでした',
        'update_success' => '仕入先が更新されました',
        'update_failed' => 'ベンダを更新できませんでした',
        'delete_success' => '仕入先を削除しました',
        'delete_failed' => 'ベンダを削除できませんでした',
    ],
    ...
    //Customer responses
    'customer' => [
        'get_success' => '顧客が正常に取得されました',
        'get_failed' => '顧客を取得できませんでした',
        'not_found' => '顧客が見つかりませんでした',
        'create_failed' => '顧客を作成できませんでした',
        'create_success' => '顧客が正常に作成されました',
        'update_success' => '顧客は正常に更新されました',
        'delete_success' => '顧客が正常に削除されました',
    ],
    ...
    //Estimate responses
    'estimate' => [
        'get_success' => '推定値は正常に取得されました',
        'get_failed' => '見積もりを取得できませんでした',
        'not_found' => '見積もりが見つかりませんでした',
        'create_failed' => '見積もりを作成できませんでした',
        'create_success' => '見積もりは正常に作成されました',
        'convert_success' => '見積もりは正常に請求書に変換されました',
        'update_success' => '推定値は正常に更新されました',
        'delete_success' => '見積もりは正常に削除されました',
        'delete_failed' => '見積もりを削除できませんでした',
        'update_failed' => '見積もりを更新できませんでした',
        'share_success' => '見積もりは正常に共有されました',
        'share_failed' => '見積もりを共有できませんでした',
        'accept_reject_success' => '見積もりは正常に拒否されました',
        'send_success' => '見積もりは正常に送信されました',
        'send_failed' => '見積もりを送信できませんでした',
