<template>
    <user-layout>
        <div id="new_invoice_page">
            <LoadingScreen :blocked="loadingData">
                <user-header :title="$t('invoice.new_invoice')"></user-header>
                <div class="card">
                    <form class="formgrid">
                        <div class="grid">
                            <TextInput id="number_input" v-model="invoice.number" class="field col-12 md:col-6" label="Number" />
                            <SelectInput
                                id="status_input"
                        ...
                        <div class="grid">
                            <div class="field col-12 md:col-6">
                                <EditorInput id="notes_input" v-model="invoice.notes" :label="$t('invoice.notes')" />
                            </div>
                            <div class="field col-12 md:col-6">
                                <InputNumber
                                    id="discount_input"
                    ...
                    <div id="function_buttons" class="flex gap-2 justify-content-end">
                        <Button :label="$t('basic.cancel')" icon="fa fa-times" class="p-button-danger" @click="goTo('/invoices')" />
                        <Button
                            :label="$t('basic.save')"
