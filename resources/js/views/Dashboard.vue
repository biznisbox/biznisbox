...
export default {
    ...
    data() {
        return {
            ...
            editDashboard: false,
            availableComponents: [
                { name: this.$t('dashboard.welcome'), component: 'Welcome', minW: 2, minH: 1.1, i: 0, permission: 'dashboard' },
                {
                ...
                { name: this.$t('dashboard.current_time'), component: 'Clock', minW: 2, minH: 1.7, i: 8, permission: 'dashboard' },
            ],
        }
    },
